    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Button variant="danger" className="gap-2" onClick={() => setDeleteDialogOpen(true)}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-[hsl(var(--card))] rounded-xl border border-[hsl(var(--border))] shadow-[var(--shadow-sm)] p-6 space-y-4">
          ...
          {data.code && (
            <div>
              ...
              <span className="inline-flex mt-1 items-center px-3 py-1 rounded-lg bg-[hsl(var(--primary)/0.1)] text-[hsl(var(--primary))] text-sm font-mono">{data.code}</span>
            </div>
          )}
          ...
          {data.parent ? (
            <div>
              ...
              <Link to={`/therapeutic-classes/${data.parent.id}`} className="inline-flex items-center gap-2 mt-1 text-sm font-medium text-[hsl(var(--primary))] hover:underline">
            ...
            <div>
              ...
              <span className="inline-flex mt-1 items-center px-2.5 py-1 rounded-full bg-[hsl(var(--primary)/0.1)] text-[hsl(var(--primary))] text-xs font-medium">تصنيف رئيسي</span>
            </div>
          )}
        ...
        <div className="bg-[hsl(var(--card))] rounded-xl border border-[hsl(var(--border))] shadow-[var(--shadow-sm)] p-6">
          <h2 className="font-semibold text-[hsl(var(--foreground))] pb-3 border-b border-[hsl(var(--border))] mb-4 flex items-center gap-2">
            ...
            التصنيفات الفرعية
            {children.length > 0 && (
              <span className="mr-auto bg-[hsl(var(--primary)/0.1)] text-[hsl(var(--primary))] text-xs font-bold px-2.5 py-0.5 rounded-full">{children.length}</span>
            )}
          </h2>
          {children.length > 0 ? (
            <div className="space-y-2">
              {children.map((child) => (
                <Link
                  ...
                  className="flex items-center justify-between p-3 rounded-lg hover:bg-[hsl(var(--accent))] border border-transparent hover:border-[hsl(var(--border))] transition-all group"
                >
                  <div className="flex items-center gap-3">
                    <div className="h-8 w-8 rounded-lg bg-[hsl(var(--primary)/0.1)] group-hover:bg-[hsl(var(--primary))] flex items-center justify-center flex-shrink-0 transition-colors">
                      <FolderTree className="h-4 w-4 text-[hsl(var(--primary))] group-hover:text-white transition-colors" />
                    </div>
                    <div>
                  ...
                  <ChevronLeft className="h-4 w-4 text-[hsl(var(--muted-foreground))] group-hover:text-[hsl(var(--primary))] transition-colors" />
                </Link>
              ))}
            </div>
          ) : (
